...
September 24 update: manual storage now uses schema 2 for individual confirmed
workout deletion. Existing schema-1 databases migrate without rewriting their
payloads. Practice storage remains unchanged. See [ADR 0017](0017-delete-manual-workout.md).
